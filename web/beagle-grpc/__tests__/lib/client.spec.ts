...
describe('src/lib/client.ts', () => {
  describe('createClient', () => {
    ...
    let fetchGrpcViewSpy: jest.SpyInstance<Promise<Response>, [name: string, client: ScreenControllerClient, fetchReq: FetchRequest]>
    let getRequestSpy: jest.SpyInstance<FetchRequest | null, [requestInfo: RequestInfo]>
    ...
    beforeAll(() => {
      ...
      global.fetch = jest.fn().mockImplementation(() => Promise.resolve(new Response()))
    })
    ...
    beforeEach(() => {
      ...
      clientOptions = {
        ...
        customHttpClient: jest.fn().mockImplementation(() => new Response())
      }      
    })

    test('it should create the client (function) using the "ScreenControllerClient" generated by the protocol buffer', () => {
    ...
    describe('fetchGrpcView', () => {
      test('it should use the "fetchGrpcView" when the url matches the grpc origin, using the client generated by the protobuf', () => {
        ...
        const screenControllerClient = new ScreenControllerClient(clientOptions.proxyAddress)
        expect(fetchGrpcViewSpy).toHaveBeenCalledWith('/my-grpc/endpoint', screenControllerClient, { url })
      })
